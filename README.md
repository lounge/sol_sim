...
18. Spawn a body with click-drag (position + velocity) (right-drag arrow preview, spawn at the cursor with the drag velocity, scroll-during-drag mass with constant-density radius and live marker, drag mass/speed title readout, numbered spawn names; three space-mixing bugs along the way turned pixel/world coordinates into distinct types) - DONE
19. Delete a body.
20. Make 3D.
21. Lighting (Sun).
