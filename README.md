...
18. Spawn a body with click-drag (position + velocity) - IN PROGRESS (core works: right-press sets position, drag-release sets velocity via screen→world inverse transform; left: mass-control, drag preview line, spawn naming)
19. Delete a body.
20. Make 3D.
21. Lighting (Sun).
